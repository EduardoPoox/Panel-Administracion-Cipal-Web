    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header bg-soft-dark">
                <h4 class="modal-title" id="standard-modalLabel">Editar Cliente</h4>
                    ...
                    <div class="form-group row mb-2">
                        ...
                        <div class="col-8">
                            <input type="date" class="form-control" id="fecha_instalacion" name="fecha_instalacion" required=""
                                value="<?php echo($fila['fecha_instalacion']);?>">
                        </div>                        
                    </div>
                    <div class="form-group row mb-2">
                    ...
                    <div class="form-group row mb-2">
                        ...
                        <div class="col-8">
                            <input type="number" class="form-control" id="dias_bloqueo" name="dias_bloqueo" required=""
                                value="<?php echo($fila['dias_bloqueo']);?>">
                        </div>                        
                    </div>
                    <div class="form-group row mb-2">
                        ...
                        <div class="col-8">
                            <input type="url" class="form-control" id="url_sitio" name="url_sitio" required=""
                                value="<?php echo($fila['url']);?>">
                        </div>                        
                    </div>                 
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-light" data-dismiss="modal">Cerrar</button>
                <button type="submit" class="btn btn-light">Editar Cliente</button>
            </div>
            </form>
        </div><!-- /.modal-content -->
    </div><!-- /.modal-dialog -->
